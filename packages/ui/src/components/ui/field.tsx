...
function FieldGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'group/field-group @container/field-group flex w-full flex-col gap-5 data-[slot=checkbox-group]:gap-2 [&>[data-slot=field-group]]:gap-3',
        className,
      )}
      {...props}
    />
...
function FieldDescription({ className, ...props }: React.ComponentProps<'p'>) {
  return (
    <p
      ...
      className={cn(
        'text-muted-foreground text-[13px] leading-normal font-normal group-has-[[data-orientation=horizontal]]/field:text-balance',
...
function FieldSeparator({
  ...
  return (
    <div
      ...
      className={cn(
        'relative -my-1.5 h-4 text-[13px] group-data-[variant=outline]/field-group:-mb-2',
        className,
      )}
      {...props}
    >

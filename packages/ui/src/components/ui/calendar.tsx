...
import { Button, buttonVariants } from '@edenscale/ui/button'
    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === 'label'
            ? 'text-sm'
            : 'rounded-md pl-2 pr-1 flex items-center gap-1 text-[13px] h-7 [&>svg]:text-muted-foreground [&>svg]:size-3.5',

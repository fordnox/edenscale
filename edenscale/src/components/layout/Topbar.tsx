      ...
      <div className="flex items-center justify-between gap-6 px-8 py-5">
        ...
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="icon" aria-label="Notifications" className="relative">
            <Bell strokeWidth={1.5} className="size-[18px] text-ink-700" />
            {unread > 0 && (
              <span className="absolute right-1.5 top-1.5 inline-block size-1.5 rounded-full bg-brass-500" />
            )}
          </Button>
          <Button variant="secondary" size="sm">New capital call</Button>
        </div>
      </div>

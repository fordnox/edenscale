    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'left' &&
            'data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left inset-y-0 left-0 h-full w-full border-r sm:max-w-sm md:w-3/4',
          side === 'top' &&
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn('font-display text-ink-900 font-semibold', className)}
      {...props}
    />
  )
}

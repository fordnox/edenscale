  ...
  return (
    <div className="flex h-full flex-col overflow-y-auto">
      <div className="border-b border-[color:var(--border-hairline)] px-6 py-5">
        ...
        <h2 className="es-display mt-2 text-[28px] leading-tight">{doc.title}</h2>
      ...
      <div className="mt-auto flex items-start gap-3 border-t border-[color:var(--border-hairline)] px-6 py-5">

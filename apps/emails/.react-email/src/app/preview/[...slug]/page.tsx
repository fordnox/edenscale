...
export function generateStaticParams() { 
  return Promise.resolve(
    [{"slug":["admin","invitation_accepted"]},{"slug":["customer","capital_call"]},{"slug":["customer","commitment_status"]},{"slug":["customer","communication"]},{"slug":["customer","distribution"]},{"slug":["customer","document_uploaded"]},{"slug":["customer","invitation"]},{"slug":["customer","letter_drafted"]},{"slug":["customer","task_assigned"]},{"slug":["customer","welcome"]},{"slug":["drip","day_1"]},{"slug":["drip","day_2"]},{"slug":["drip","day_3"]},{"slug":["drip","day_4"]},{"slug":["drip","day_5"]},{"slug":["drip","day_6"]},{"slug":["drip","day_7"]}]
  );
}
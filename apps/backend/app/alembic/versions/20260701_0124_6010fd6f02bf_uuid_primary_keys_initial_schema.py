...
def upgrade():
    ...
    sa.Column('role', sa.Enum('superadmin', 'admin', 'fund_manager', 'lp', name='user_role'), nullable=False),
    ...
    op.create_table('investor_contacts',
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    sa.Column('organization_id', sa.Uuid(), nullable=False),
    sa.Column('email', sa.String(length=255), nullable=False),
    sa.Column('role', sa.Enum('superadmin', 'admin', 'fund_manager', 'lp', name='invitation_role'), nullable=False),
    ...
    sa.Column('user_id', sa.Uuid(), nullable=False),
    sa.Column('organization_id', sa.Uuid(), nullable=False),
    sa.Column('role', sa.Enum('superadmin', 'admin', 'fund_manager', 'lp', name='membership_role'), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['organization_id'], ['organizations.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    ...
    op.create_table('fund_team_members',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('fund_id', sa.Uuid(), nullable=False),
    sa.Column('user_id', sa.Uuid(), nullable=False),
    sa.Column('title', sa.String(length=150), nullable=True),
    ...
    op.create_table('capital_call_items',
    sa.Column('id', sa.Uuid(), nullable=False),

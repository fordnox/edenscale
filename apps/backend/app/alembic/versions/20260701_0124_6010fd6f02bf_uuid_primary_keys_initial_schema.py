"""uuid_primary_keys_initial_schema

Revision ID: 6010fd6f02bf
Revises:
Create Date: 2026-07-01 01:24:43.249734
...
def upgrade():
    ...
    op.create_index(
        op.f("ix_investors_organization_id"),
        "investors",
        ["organization_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("superadmin", "admin", "fund_manager", "lp", name="user_role"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_users_hanko_subject_id"), "users", ["hanko_subject_id"], unique=True
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_fund_groups_created_by_user_id"),
        "fund_groups",
        ["created_by_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_fund_groups_organization_id"),
        "fund_groups",
        ["organization_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_investor_contacts_investor_id"),
        "investor_contacts",
        ["investor_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_investor_contacts_user_id"),
        "investor_contacts",
        ["user_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("unread", "read", "archived", name="notification_status"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum(
                "superadmin", "admin", "fund_manager", "lp", name="invitation_role"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum(
                "superadmin", "admin", "fund_manager", "lp", name="membership_role"
            ),
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("organization_id", sa.Uuid(), nullable=False),
        sa.Column("fund_group_id", sa.Uuid(), nullable=True),
        sa.Column("name", sa.String(length=255), nullable=False),
        sa.Column("legal_name", sa.String(length=255), nullable=True),
    ...
    op.create_index(
        op.f("ix_funds_fund_group_id"), "funds", ["fund_group_id"], unique=False
    )
    op.create_index(
        op.f("ix_funds_organization_id"), "funds", ["organization_id"], unique=False
    )
    op.create_table(
        "capital_calls",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_capital_calls_created_by_user_id"),
        "capital_calls",
        ["created_by_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_capital_calls_fund_id"), "capital_calls", ["fund_id"], unique=False
    )
    op.create_table(
        "commitments",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.Column("investor_id", sa.Uuid(), nullable=False),
        sa.Column(
            "committed_amount", sa.Numeric(precision=18, scale=2), nullable=False
        ),
        sa.Column("called_amount", sa.Numeric(precision=18, scale=2), nullable=False),
        sa.Column(
            "distributed_amount", sa.Numeric(precision=18, scale=2), nullable=False
        ),
        sa.Column("commitment_date", sa.Date(), nullable=False),
        sa.Column(
            "status",
            sa.Enum(
                "pending", "approved", "declined", "cancelled", name="commitment_status"
            ),
            nullable=False,
        ),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "fund_id", "investor_id", name="uq_commitment_fund_investor"
        ),
    )
    op.create_index(
        op.f("ix_commitments_fund_id"), "commitments", ["fund_id"], unique=False
    )
    op.create_index(
        op.f("ix_commitments_investor_id"), "commitments", ["investor_id"], unique=False
    )
    op.create_table(
        "communications",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.Column(
            "type",
            sa.Enum(
                "announcement", "message", "notification", name="communication_type"
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_communications_fund_id"), "communications", ["fund_id"], unique=False
    )
    op.create_index(
        op.f("ix_communications_sender_user_id"),
        "communications",
        ["sender_user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_distributions_created_by_user_id"),
        "distributions",
        ["created_by_user_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_distributions_fund_id"), "distributions", ["fund_id"], unique=False
    )
    op.create_table(
        "documents",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_documents_fund_id"), "documents", ["fund_id"], unique=False
    )
    op.create_index(
        op.f("ix_documents_investor_id"), "documents", ["investor_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        "capital_call_items",
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("capital_call_id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_capital_call_items_capital_call_id"),
        "capital_call_items",
        ["capital_call_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_capital_call_items_commitment_id"),
        "capital_call_items",
        ["commitment_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("user_id", sa.Uuid(), nullable=True),
        sa.Column("investor_contact_id", sa.Uuid(), nullable=True),
    ...
    op.create_index(
        op.f("ix_communication_recipients_communication_id"),
        "communication_recipients",
        ["communication_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_communication_recipients_investor_contact_id"),
        "communication_recipients",
        ["investor_contact_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_communication_recipients_user_id"),
        "communication_recipients",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_distribution_items_commitment_id"),
        "distribution_items",
        ["commitment_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_distribution_items_distribution_id"),
        "distribution_items",
        ["distribution_id"],
        unique=False,
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_distribution_items_distribution_id"), table_name="distribution_items"
    )
    op.drop_index(
        op.f("ix_distribution_items_commitment_id"), table_name="distribution_items"
    )
    ...
    op.drop_index(
        op.f("ix_capital_call_items_commitment_id"), table_name="capital_call_items"
    )
    op.drop_index(
        op.f("ix_capital_call_items_capital_call_id"), table_name="capital_call_items"
    )
    ...
    op.drop_index(
        op.f("ix_distributions_created_by_user_id"), table_name="distributions"
    )
    ...
    op.drop_index(
        op.f("ix_capital_calls_created_by_user_id"), table_name="capital_calls"
    )
    ...
    op.drop_index(
        op.f("ix_investor_contacts_investor_id"), table_name="investor_contacts"
    )

...
export default function UserDashboardPage() {
  ...
  const primaryActionPath = nextStep?.to ?? (managerOrgSlug ? orgPath(managerOrgSlug) : "/app")
        ...
        actions={
          <>
            ...
            <Button
              ...
              disabled={!managerMembership && nextStep?.to !== "/app/onboarding"}
            >
                  ...
                  <div className="grid grid-cols-1 gap-0 border border-[color:var(--border-hairline)] md:grid-cols-2">
                    {onboardingSteps.map((step, index) => (
                      <button
                        ...
                        disabled={!managerMembership && step.to !== "/app/onboarding" && step.to !== "/app"}
